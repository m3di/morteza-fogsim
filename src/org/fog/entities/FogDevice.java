...
public class FogDevice extends PowerDatacenter {
    ...
    protected Map<Integer, Double> neighbours;
    ...
    public FogDevice(
        ...
        setNeighboursLatencyMap(new HashMap<Integer, Double>());
    }
            ...
            if (appToModulesMap.get(tuple.getAppId()).contains(tuple.getDestModuleName())) {
                ...
                if (tuple.getDirection() == Tuple.UP)
                    ...
                    if (getLevel() != 2 || tuple.getPartyEntryDevice() == getId()) {
                        ...
                        if (!tuple.getNeighboursPassed().contains(getId())) {
                            tuple.getNeighboursPassed().add(getId());
                        }
    ...
    public Map<Integer, Double> getNeighboursLatencyMap() {
        return neighbours;
    }

    public void setNeighboursLatencyMap(Map<Integer, Double> latencyMap) {
        this.neighbours = latencyMap;
    }

    public void setNeighboursLatency(Integer neighbour, Double lat) {
        this.neighbours.put(neighbour, lat);
    }
