...
public class Application {
     ...
     * @param ram
     */
    public void addAppModule(String moduleName, int mips, int ram, int bw) {
        long size = 10000;
        String vmm = "Xen";
    ...
    public Application(String appId, List<AppModule> modules, List<AppEdge> edges, List<AppLoop> loops, GeoCoverage geoCoverage) {
        setAppId(appId);
        setModules(modules);
        setEdges(edges);
