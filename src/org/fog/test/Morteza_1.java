 ...
 * @author moham
 */
public class Morteza_1 {

    public static void main(String[] args) {

        Log.printLine("Starting Morteza...");
        ...
        try {
            ...
            PhysicalTopology physicalTopology = JsonToTopology.getPhysicalTopology(
                    broker.getId(),
                    appId,
                    "topologies/mm"
            );
...
//                    ModuleMapping.createModuleMapping()
            ...
            Log.printLine("morteza finished!");
        } catch (Exception e) {
            e.printStackTrace();
...
//        application.addTupleMapping("client", "TEMP", "ACTUATOR", new FractionalSelectivity(1.0));
